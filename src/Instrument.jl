...
virtis_h = instrument(1, 3, 0, 0.1, "ROS_VIRTIS-H")
debug = instrument(100, 100, 1.5, 1.5, "ROS_NADIR")
testInstrument = instrument(200 ,200 ,3.0 ,3.0 ,"ROS_NADIR")
...
rosetta_instruments["VIRTIS_H"] = virtis_h
rosetta_instruments["DEBUG"] = debug
rosetta_instruments["TEST"] = testInstrument
